...
const nuts_slovenia = [
	...
	{src: 'SI010', src_name: 'Vzhodna Slovenija', dest: 'SI03', dest_name: 'Eastern Slovenia (Vzhodna Slovenija)'},
	{src: 'SI011', src_name: 'Pomurska', dest: 'SI031', dest_name: 'Mura Statistical Region (Pomurska statistična regija)'},
	{src: 'SI012', src_name: 'Podravska', dest: 'SI032', dest_name: 'Drava Statistical Region (Podravska statistična regija)'},
	{src: 'SI013', src_name: 'Koroska', dest: 'SI033', dest_name: 'Drava Statistical Region (Podravska statistična regija)'},
	{src: 'SI014', src_name: 'Savinjska', dest: 'SI034', dest_name: 'Savinja Statistical Region (Savinjska statistična regija)'},
	{src: 'SI015', src_name: 'Zasavska', dest: 'SI035', dest_name: 'Central Sava Statistical Region (Zasavska statistična regija)'},
	{src: 'SI016', src_name: 'Spodnjeposavska', dest: 'SI036', dest_name: 'Lower Sava Statistical Region (Spodnjeposavska statistična regija)'},
	{src: 'SI017', src_name: 'Jugovzhodna Slovenija', dest: 'SI037', dest_name: 'Southeast Slovenia Statistical Region (Jugovzhodna Slovenija statistična regija)'},
	{src: 'SI018', src_name: 'Notranjsko - kraska', dest: 'SI038', dest_name: 'Inner Carniola–Karst Statistical Region (Notranjsko-kraška statistična regija)'},
	{src: 'SI020', src_name: 'Zahodna Slovenija', dest: 'SI04', dest_name: 'Zahodna Slovenija'},
	{src: 'SI021', src_name: 'Osrednjeslovenska', dest: 'SI041', dest_name: 'Central Slovenia Statistical Region (Osrednjeslovenska statistična regija)'},
	{src: 'SI022', src_name: 'Gorenjska', dest: 'SI042', dest_name: 'Upper Carniola Statistical Region (Gorenjska statistična regija)'},
	{src: 'SI023', src_name: 'Goriska', dest: 'SI043', dest_name: 'Gorizia Statistical Region (Goriška statistična regija)'},
	{src: 'SI024', src_name: 'Obalno - kraska', dest: 'SI044', dest_name: 'Coastal–Karst Statistical Region (Obalno-kraška statistična regija)'},
	{src: 'SI01', src_name: 'Vzhodna Slovenija', dest: 'SI03', dest_name: 'Eastern Slovenia (Vzhodna Slovenija)'},
	{src: 'SI02', src_name: 'Zahodna Slovenija', dest: 'SI04', dest_name: 'Zahodna Slovenija'},
	//2003
	{src: 'SI001', src_name: 'Pomurska', dest: 'SI031', dest_name: 'Mura Statistical Region (Pomurska statistična regija)'},
	{src: 'SI002', src_name: 'Podravska', dest: 'SI032', dest_name: 'Drava Statistical Region (Podravska statistična regija)'},
	{src: 'SI003', src_name: 'Koroska', dest: 'SI033', dest_name: 'Drava Statistical Region (Podravska statistična regija)'},
	{src: 'SI004', src_name: 'Savinjska', dest: 'SI034', dest_name: 'Savinja Statistical Region (Savinjska statistična regija)'},
	{src: 'SI005', src_name: 'Zasavska', dest: 'SI035', dest_name: 'Central Sava Statistical Region (Zasavska statistična regija)'},
	{src: 'SI006', src_name: 'Spodnjeposavska', dest: 'SI036', dest_name: 'Lower Sava Statistical Region (Spodnjeposavska statistična regija)'},
	{src: 'SI009', src_name: 'Gorenjska', dest: 'SI042', dest_name: 'Upper Carniola Statistical Region (Gorenjska statistična regija)'},
	{src: 'SI00A', src_name: 'Obalno - kraska', dest: 'SI044', dest_name: 'Coastal–Karst Statistical Region (Obalno-kraška statistična regija)'},
	{src: 'SI00B', src_name: 'Goriska', dest: 'SI043', dest_name: 'Gorizia Statistical Region (Goriška statistična regija)'},
	{src: 'SI00C', src_name: 'Notranjsko - kraska', dest: 'SI048', dest_name: 'Inner Carniola–Karst Statistical Region (Notranjsko-kraška statistična regija)'},
	{src: 'SI00D', src_name: 'Jugovzhodna Slovenija', dest: 'SI047', dest_name: 'Southeast Slovenia Statistical Region (Jugovzhodna Slovenija statistična regija)'},
	{src: 'SI00E', src_name: 'Osrednjeslovenska', dest: 'SI041', dest_name: 'Central Slovenia Statistical Region (Osrednjeslovenska statistična regija)'}
];
...
class TenderConverter {
	...
	cleanIndicators(list) {
		...
		if (list) {
			list.forEach(doc => {
				this.cleanProperties(['_id', 'id', 'relatedEntityId', 'created', 'modified', 'createdBy', 'modifiedBy', 'createdByVersion', 'modifiedByVersion', 'metaData'], doc);
			});
		}
		return list;
	};
